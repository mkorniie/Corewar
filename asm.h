...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/22 11:38:47 by mkorniie          #+#    #+#             */
/*   Updated: 2018/08/22 11:38:49 by mkorniie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define REG_NUM_NOT_PINT		"Registry number is not a positive int!\n"
...
# define INVALID_FIRST_ARG		"First arg not a label and not a command!'%s'\n"
# define WRONG_N_OF_ARGS		"Something's wrong with a number of args!'%s'\n"
...
# define BOT_NAME_ERR			"Error in bot name - something after quotes!\n"
# define NO_NAME				"No name string\n"
# define NAME_QUOTE_ERR			"Name is not in quotes or whatever\n"
...
char							*ft_quotetrim(char *raw_name,
	t_declare *glob_struct);
void							ft_addsequence(char *read_line,
	t_declare *glob_struct);
...
int								ft_count_label(t_label *start_label,
	t_comline *command, int index);
